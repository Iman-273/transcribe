...
const MyAudios: React.FC = () => {
  ...
  const handleReviewClick = (audio: AudioItem) => setSelectedAudio(audio);
  const handleBack = () => setSelectedAudio(null);
        ...
        <main className="flex-1 p-4 sm:p-6">
          {selectedAudio ? (
            ...
            <div className="space-y-6">
              ...
              {/* Audio Info Header */}
              <div className="bg-white p-4 sm:p-5 rounded-xl shadow-sm flex flex-col sm:flex-row justify-between sm:items-center gap-3">
                <div>
                ...
                {/* Buttons (Non-expanding) */}
                <div className="flex flex-wrap sm:flex-nowrap gap-2">
                  <button
                    onClick={() => setShowComments(true)}
                    className="flex items-center gap-2 px-3 py-1.5 border rounded-lg text-sm text-gray-600 hover:bg-gray-100 transition whitespace-nowrap"
                  >
                    <MessageSquare size={16} /> Comments ({comments.length})
                  </button>
                  <button className="flex items-center gap-2 px-3 py-1.5 border rounded-lg text-sm text-gray-600 hover:bg-gray-100 transition whitespace-nowrap">
                    <Save size={16} /> Save as Draft
                  </button>
                  <button className="px-3 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm transition whitespace-nowrap">
                    Submit Review
                  </button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* Edit Transcription */}
                <div className="bg-white p-4 sm:p-5 rounded-xl shadow-sm flex flex-col">
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-4 gap-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <button className="flex items-center gap-2 px-3 py-1.5 border rounded-xl text-sm text-gray-600 hover:bg-gray-100 transition whitespace-nowrap">
                    <Filter size={16} />
                    Filter
                  </button>
                  <button className="flex items-center gap-2 px-3 py-1.5 border rounded-xl text-sm text-gray-600 hover:bg-gray-100 transition whitespace-nowrap">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-blue-600 text-white text-sm rounded-xl hover:bg-blue-700 transition whitespace-nowrap"
                  >
                    Load Dummy Data
                  </button>
                </div>
              ...
              {/* Tabs */}
              <div className="border-b mb-4 flex flex-wrap gap-4 text-sm font-medium text-gray-600">
              ...
              {audios.length === 0 ? (
                ...
                <div className="space-y-3">
                  {filteredAudios.map((audio) => (
                    <div
                      key={audio.id}
                      className="flex flex-col sm:flex-row sm:items-center sm:justify-between border rounded-xl p-4 bg-white shadow-sm hover:shadow-md transition gap-3"
                    >
                      ...
                      <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 sm:gap-6 justify-between sm:justify-end w-full sm:w-auto">
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-xl flex items-center gap-2 text-sm whitespace-nowrap ${
                            audio.status === "Pending"
          ...
          {showComments && (
            <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-end z-50">
              <div className="w-full sm:w-96 bg-white h-full shadow-xl p-5 flex flex-col">
