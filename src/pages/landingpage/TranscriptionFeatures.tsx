    ...
    <section className="w-full bg-white py-28 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20">
          <div className="inline-block bg-[#F1F7FF] text-[#0F172A] px-5 py-1.5 rounded-full text-sm font-medium mb-5 shadow-sm">
            Why Choose us
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
          ...
          <div className="bg-[#F9FBFF] rounded-[28px] p-6 relative">
            <div className="bg-white rounded-2xl shadow-sm border border-[#E5E9F0] p-6">
              <h3 className="text-[#0F172A] font-semibold text-base mb-1">
                Interview Recording 001
              </h3>
              <p className="text-[#64748B] text-sm mb-5">Assigned on 10/14/2025</p>

              <div className="border border-[#E5E9F0] rounded-2xl p-5 mb-4">
                <p className="text-[#0F172A] text-sm font-medium mb-3">
                  Audio Player
                </p>

                {/* Waveform */}
                <div className="bg-gradient-to-r from-[#E8F3FF] to-[#FFF6ED] rounded-lg h-20 mb-4 flex items-center justify-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 100 30"
                    className="w-3/4 h-8 text-orange-500"
                    fill="currentColor"
                  >
                ...
                <div className="relative w-full h-2 bg-gray-200 rounded-full mb-5">
                  <div className="absolute left-0 top-0 h-2 w-1/4 bg-blue-500 rounded-full"></div>
                  <div className="absolute left-1/4 top-1/2 w-4 h-4 bg-white border border-gray-300 rounded-full transform -translate-y-1/2"></div>
                </div>
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-sm text-gray-700">05:00</span>
                </div>
          ...
          <div className="space-y-10">
            {[
              ...
              <div
                key={index}
                className="border-l-4 border-[#007BCE] pl-6 hover:translate-x-1 transition-transform duration-300"
              >
