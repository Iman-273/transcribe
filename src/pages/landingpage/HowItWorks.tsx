      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-8 items-start">
          {steps.map((step, index) => (
            ...
            >
              <Card className="flex flex-col justify-between w-full bg-white border border-[#E5E9F0] shadow-[0_4px_12px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.08)] transition-shadow duration-300 rounded-3xl">
