    ...
    <div className="flex min-h-screen flex-col bg-[#FAFAFA]">
      ...
      <main className="flex-1 p-6">
        ...
        <Tabs defaultValue="profile" className="w-full">
          <TabsList className="border-b border-gray-200 bg-transparent w-full justify-start gap-6 px-1 mb-5">
            <TabsTrigger
              value="profile"
              className="data-[state=active]:text-blue-600 data-[state=active]:border-b-2 border-blue-600 text-sm font-medium text-gray-600 pb-2"
            >
              Personal Profile
            </TabsTrigger>
            <TabsTrigger
     ...
     {/* Personal Profile Tab (Final Polished Version) */}
<TabsContent value="profile">
  <Card className="rounded-xl border border-gray-200 bg-white shadow-sm">
    <CardContent className="p-6">
      {/* Profile Upload Section */}
      <div className="flex flex-col items-center justify-center border border-dashed border-gray-300 rounded-xl py-10 mb-8 bg-white">
              ...
              <Card className="rounded-xl border border-gray-200 bg-white shadow-sm">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-between border border-gray-200 rounded-lg px-4 py-3 mb-4">
                    ...
                    <Button
                      variant="outline"
                      className="text-sm font-medium h-8 px-3 border-gray-300"
                    >
                      Edit
                    </Button>
                  </div>
            ...
            <Card className="rounded-xl border border-gray-200 bg-white shadow-sm">
              <CardContent className="p-0 divide-y divide-gray-200">
                {notifications.map((item, index) => (
                  <div
                    key={index}
                    className="flex flex-col md:flex-row justify-between items-start md:items-center px-6 py-5"
                  >
